...
export default function Rank() {
  ...
  const [PledgeEarnRecord, setPledgeEarnRecord] = useState<any>({});
  ...
  return (
    <div className="pledge_out_record">
      ...
      <div className="record_content">
        <div>
          <div className="data_box">
            <div className="data_item">
              ...
              <div className="get_box">
                <span>
                  <img src={coin_logo} alt="" /> {BoxUserInfo?.amount ?? 0}
                </span>
                <div
                  onClick={() => {
                    if (
                      !!BoxUserInfo?.amount &&
                      Number(BoxUserInfo?.amount) > 0
                    ) {
                      withdrawFun();
                    }
                  }}
          ...
          <div className="table_title">{t("领取明细")}</div>
          <div className="table_box">
            <div className="title items">
              <div className="item">{t("时间")}</div>
              <div className="item">{t("领取数量")}</div>
            </div>
