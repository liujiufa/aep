...
import { getNodeData, getNodeRecord } from "../API";
        ...
        <div>
          <div className="data_box">
            <div className="data_item">
              {t("节点奖励")}{" "}
              <span>
                <img src={coin_logo} alt="" /> {NumSplic1(NodeData?.nodeAward, 4) ?? 0}
              </span>
            </div>
          </div>
          <div className="table_title">{t("奖励明细")}</div>
          <div className="table_box">
            <div className="title items">
              <div className="item">{t("时间")}</div>
              <div className="item">{t("发放数量")}</div>
            </div>
