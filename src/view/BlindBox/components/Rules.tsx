...
const ModalContainer_Content = styled.div`
  ...
  .items {
    ...
    .item {
      ...
      font-style: normal;
      font-weight: 400;
      line-height: 1.66667rem; /* 142.857% */
      ul {
        margin-bottom: 0px;
        li {
          display: flex;
            ...
            <div className="item">
              <ul>
                ...
                <li>
                  ...
                  盲盒二：1001-5000 USDT,获得2.5倍本金Token.
                </li>
                <li>
                  <div>
                    <svg
                  ...
                  盲盒三：5001-10000 USDT,获得3倍本金Token.
                </li>
              </ul>
            </div>
            <div className="item">2.Token 代币每天释放0.7%-0.1%.</div>
          </div>
          <div
            className="confirm"
            onClick={() => {
